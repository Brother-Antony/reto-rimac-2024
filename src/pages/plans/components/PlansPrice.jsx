...
export default function PlansPrice({ plans, selectedOption, loadingId, loading, priceParaMi, imageMappings, handleSummary }) {
    return (
        <div className="planPrice">
            {plans.map((plan, index) => (
                <div key={index} className={`w-[288px] pt-[68px] pb-[51px] px-[32px] shadow-[0_1px_24px_0_rgba(174,172,243,.251)] rounded-[24px] flex flex-col relative transition-all ${loading ? 'opacity-0' : 'opacity-100 duration-700'}`}>
